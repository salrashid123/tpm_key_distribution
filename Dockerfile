...
RUN protoc -I src/ --include_imports --include_source_info --descriptor_set_out=src/verifier/verifier.proto.pb  --go_out=plugins=grpc:src/ src/verifier/verifier.proto
